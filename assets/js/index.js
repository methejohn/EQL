...
gsap.set('.sc-honsby .group-right .bg',{scaleY:0, transformOrigin: "100% 0%"})
...
ScrollTrigger.create({
    ...
    start: "0% 60%",
    onEnter:function(){
        gsap.to('.sc-honsby .group-right .bg',1.5,{
            scaleY:1,
            ease:"power1.inOut"
        },'g')
        gsap.to('.sc-honsby .group-right .video1 img',1.5,{
            scale:1,
            opacity:1,
            ease:"power1.inOut"
        },'g+=0.1')
        gsap.to('.sc-honsby .group-left .left-area h2 .line span',1.5,{
            yPercent:0,
            ease:"power1.inOut",
            stagger:{
                each:0.1
